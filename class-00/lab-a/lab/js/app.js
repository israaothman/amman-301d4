...
function displayPics(){
  ...
  //because the rando variable was declared locally inside the while loop which is code block and we know that when we declare a variable using const it will be defined inside the code block only 
  console.log(viewed);
